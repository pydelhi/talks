...
Speakers put effort into their proposals. A review generated by an AI is not a genuine response to that effort, even if it is polished and coherent. It also means the reviewer has not actually engaged with the proposal, which defeats the purpose of having human reviewers at all.
